...
export default defineConfig({
  ...
  projects: [
    {
      name: 'raw',
      testMatch: ['app.spec.js', 'artifacts.spec.js', 'cdu.spec.js', 'launcher.spec.js', 'brand.spec.js', 'security.spec.js'],
    ...
    },
    {
      ...
      testMatch: ['app.spec.js', 'visual.spec.js', 'perf.spec.js', 'cdu.spec.js', 'launcher.spec.js', 'brand.spec.js', 'security.spec.js'],
