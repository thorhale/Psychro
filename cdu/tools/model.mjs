...
export const RC_SEC = [-13.7265, 1431.23, 3972770];
export const PH_SEC = [-0.00293773, 0.0430909, 154.305, 7920.19];
export const RC_PRI = [0.563701, -1608.63, 4209480];
export const PH_PRI = [0.00052677, -0.552665, 216.187, 13989.7];
